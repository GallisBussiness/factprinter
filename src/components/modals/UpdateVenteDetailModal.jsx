...
function UpdateVenteDetailModal({ isOpen, onResolve, onReject, vente }) {
  const defaultValues = { date: vente?.date, montant: vente?.montant };
  const {
    control,
    handleSubmit,
    formState: { errors },
...
export default create(UpdateVenteDetailModal);
