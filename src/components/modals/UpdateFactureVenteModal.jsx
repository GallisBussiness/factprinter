...
function UpdateFactureVenteModal({
  isOpen,
  onResolve,
  onReject,
  client,
  ...
  const defaultValues = {
    ...
    client,
    avance: factureVente?.avance,
    total: factureVente?.total,
  };
  const {
    control,
    handleSubmit,
  ...
  return (
    <>
      <Dialog
        header="Enregistrer Dette Client"
        visible={isOpen}
...
export default create(UpdateFactureVenteModal);
