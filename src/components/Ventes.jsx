  ...
  const leftToolbarTemplate = () => {
      return (
          <div className="flex items-center justify-center space-x-2">
            <Button className="bg-green-500 hover:bg-green-700" onClick={() => handleCreateVente()} leftIcon={<AiOutlinePlus />}>Nouveau</Button>
                <Button className="bg-red-500 hover:bg-red-700" onClick={() => handleDelete()} disabled={!selectedVentes || !selectedVentes.length} leftIcon={<MdDelete />}> Supprimer</Button>
          </div>
      )
  }
...
const restantTemplate = (row) => {
 ...
 return  <>
  ...
  const actionBodyTemplate = (rowData) => {
     ...
     <ActionIcon color="green" size="lg" onClick={() => handleUpdateVente(rowData)}>
      <BsPencilSquare size={26} />
    </ActionIcon>
    <ActionIcon color="blue" size="lg" onClick={() => handleViewVente(rowData)}>
      <BsEye size={26} />
    </ActionIcon>
      </div>;
        ...
        <div className="flex flex-wrap -mx-3">
          <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
            <div className="flex items-center justify-center h-full">
              ...
              <img className="relative z-20 w-32 pt-6 h-32" src="/img/facture.svg" alt="facture" />
            </div>
          </div>
